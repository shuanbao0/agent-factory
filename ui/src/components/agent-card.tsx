...
import { Zap, CheckCircle, Pencil, Trash2, ChevronRight, Loader2, RefreshCw } from 'lucide-react'
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 mt-3 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1"><CheckCircle className="w-3 h-3" />{agent.tasksCompleted} {t('common.tasks')}</span>
              {template && (
