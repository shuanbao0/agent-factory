/**
 * Bridge: import CJS core modules into Next.js TypeScript.
 * All core/**/*.cjs modules are accessed through this single entry point.
 */
...
const baseRepoMod = require('../../../core/repo/base.cjs')
const configRepoMod = require('../../../core/repo/config.cjs')
const projectMetaRepoMod = require('../../../core/repo/project-meta.cjs')
const agentMetaRepoMod = require('../../../core/repo/agent-meta.cjs')
const deptConfigRepoMod = require('../../../core/repo/dept-config.cjs')
...
const stateMachineMod = require('../../../core/task/state-machine.cjs')
...
const agentServiceMod = require('../../../core/common/agent-service.cjs')
...
const validatorsMod = require('../../../core/common/validators.cjs')
...
const taskStrategyMod = require('../../../core/task/strategy.cjs')
