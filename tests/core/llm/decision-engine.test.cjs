...
describe('chief-decision-engine', () => {
  ...
  beforeEach(() => {
    ...
    const clientPath = require.resolve('../../../core/llm/anthropic-client.cjs')
    ...
    const enginePath = require.resolve('../../../core/llm/decision-engine.cjs')
    delete require.cache[enginePath]
    const engine = require('../../../core/llm/decision-engine.cjs')
